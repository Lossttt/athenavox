...
public class VoteCounter {
    ...
    public VoteCounter(String filename) throws Exception {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(filename))) {
            ...
            while ((line = reader.readLine()) != null) {
                int vote = Integer.parseInt(line, 16); // For each line, the code converts it from a hexadecimal string
                                                       // to an integer using Integer.parseInt
    ...
    public void printHistogram() throws Exception {
        ...
        HistogramPrinter h_candidates = new HistogramPrinter("Histogram of total votes per candidate:", NUM_CANDIDATES,
                row_names);
        ...
        HistogramPrinter h_male = new HistogramPrinter("Histogram of male votes per candidate:", NUM_CANDIDATES,
                row_names);
        ...
        HistogramPrinter h_female = new HistogramPrinter("Histogram of female votes per candidate:", NUM_CANDIDATES,
                row_names);
    ...
    public void printTables() throws Exception {
        ...
        TablePrinter t_candidates = new TablePrinter("Table of total votes per candidate:", NUM_CANDIDATES, row_names);
        for (int i = 0; i < NUM_CANDIDATES; i++) {
        ...
        TablePrinter t_male = new TablePrinter("Table of male votes per candidate:", NUM_CANDIDATES, row_names);
        ...
        TablePrinter t_female = new TablePrinter("Table of female votes per candidate:", NUM_CANDIDATES, row_names);
